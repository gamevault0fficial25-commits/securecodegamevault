...
// ─── CONSTANTS ───────────────────npm run lint -- --fix────────────────────────────────────────────
const PLANS = {
  basic:    { name: "Basic",    price: 99,   durationDays: 30,  features: ["Access to basic games", "5 downloads/day"] },
  premium:  { name: "Premium",  price: 199,  durationDays: 90,  features: ["All games", "Unlimited downloads", "Priority support"] },
  lifetime: { name: "Lifetime", price: 499,  durationDays: null, features: ["Lifetime access", "All future games", "VIP support"] },
};
...
exports.getDashboardStats = functions.https.onCall(async (data, context) => {
  ...
  return {
    ...
    revenue: {
      ...
      byPlan: {
        basic: revenueStats.revenue_basic || 0,
        premium: revenueStats.revenue_premium || 0,
        lifetime: revenueStats.revenue_lifetime || 0,
      },
